        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center space-x-4 pt-2">
              <a href="#" className="p-2 bg-slate-800 hover:bg-primary-600 hover:text-white rounded-lg transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/courses" className="hover:text-primary-400 transition-colors">All Courses</Link>
              </li>
              <li>
                <Link to="/about" className="hover:text-primary-400 transition-colors">About Platform</Link>
              </li>
              <li>
                <Link to="/login" className="hover:text-primary-400 transition-colors">Student Login</Link>
              </li>
              <li>
                <Link to="/register" className="hover:text-primary-400 transition-colors">Instructor Signup</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/courses?category=Web%20Development" className="hover:text-primary-400 transition-colors">Web Development</Link>
              </li>
              <li>
                <Link to="/courses?category=Data%20Science" className="hover:text-primary-400 transition-colors">Data Science & AI</Link>
              </li>
              <li>
                <Link to="/courses?category=Design" className="hover:text-primary-400 transition-colors">UI/UX Design</Link>
              </li>
              <li>
                <Link to="/courses?category=Cloud" className="hover:text-primary-400 transition-colors">Cloud & DevOps</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2.5">
                ...
                <span className="text-slate-400">support@eduflow.com</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-primary-400" />
                <span className="text-slate-400">+1 (800) 555-EDULMS</span>
              </li>
              <li className="flex items-center gap-2.5">
