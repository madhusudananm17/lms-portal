...
const Sidebar = () => {
  ...
  const adminLinks = [
    ...
    { to: '/admin/students', label: 'Students Roster', icon: UserCheck },
    { to: '/admin/instructors', label: 'Instructors', icon: ShieldCheck },
    { to: '/admin/courses', label: 'Course Catalog', icon: BookOpen },
    { to: '/admin/categories', label: 'Categories', icon: FolderTree },
    { to: '/admin/enrollments', label: 'Enrollments', icon: Award },
